...
-- Insert 100 Students
INSERT INTO Student (StudentName, Department, AdmissionDate, HomeDistrict) VALUES
...
-- Insert 10 Courses
INSERT INTO Course (CourseName, CourseCredit) VALUES
...
INSERT INTO CourseRegistration (StudentID, CourseID, Semester) VALUES
(1, 1, 'Spring 2024'),
(1, 3, 'Spring 2024'),
(2, 2, 'Spring 2024'),
(2, 4, 'Spring 2024'),
...
SELECT HomeDistrict, COUNT(*) as StudentCount
FROM Student
GROUP BY HomeDistrict
ORDER BY StudentCount DESC;
