...
(() => {
  ...
  function Se(e, r) {
      ...
      if (!(v === Qe && ((d = e.charCodeAt(f + 1)), d === ae)))
        if (v === _e) (c === '' && (h = f), (c += e.slice(f, f + 2)), (f += 1));
          ...
          if (v === ae) {
            ...
            if (u === '')
              throw new se('Missing opening {', i ? [i, f, f] : null);
    ...
    if (c.charCodeAt(0) === Ct) {
      let f = ze(c);
      (i && ((f.src = [i, h, e.length]), (f.dst = [i, h, e.length])),
        t.push(f));
    }
    if (u.length > 0 && a) {
      if (a.kind === 'rule')
    ...
    for (let s = r + 1; s < e.length; s++)
      if (((n = e.charCodeAt(s)), n === _e)) s += 1;
        ...
        if (
          n === Je &&
          (e.charCodeAt(s + 1) === ae ||
            (e.charCodeAt(s + 1) === Qe && e.charCodeAt(s + 2) === ae))
        )
          throw new se(
    ...
    keysInNamespaces(r) {
      ...
      for (let t of r) {
        ...
        for (let s of this.values.keys())
          s.startsWith(n) &&
            s.indexOf('--', 2) === -1 &&
            (or(s, t) || i.push(s.slice(n.length)));
      }
      return i;
    }
    get(r) {
      ...
      for (let t of i) {
        ...
        if (!this.values.has(n))
          if (r !== null && r.includes('.')) {
            if (((n = `${t}-${r.replaceAll('.', '_')}`), !this.values.has(n)))
              continue;
          } else continue;
        if (!or(n, t)) return n;
      }
  ...
  function hr(e, r = () => O.Continue, i = () => O.Continue) {
    ...
    for (; t.length > 0; ) {
      ...
      if (((n.parent = u), (n.depth = s), c >= 0)) {
        ...
        switch (k.kind) {
          case 0: {
            (v.nodes && v.nodes.length > 0 && t.push([v.nodes, 0, v]),
              (a[1] = ~c));
            continue;
          }
          case 2:
      ...
      switch (f.kind) {
        ...
        default:
          throw new Error(
            `Invalid \`WalkAction.${St[f.kind] ?? `Unknown(${f.kind})`}\` in exit.`
          );
      }
    }
  }
                ...
                (D(P.nodes, (j) => {
                  ...
                  do {
                    ...
                    if (
                      (ne.add(l),
                      (y = !0),
                      (B = r.theme.resolveValue(null, [le.value])),
                      !B)
                    ) {
                      L = !0;
                      return;
...
`),
    ...
    for (let [d, f] of h) {
      ...
      }
      {
        ...
        if (k !== -1) {
          ...
          let x =
            m === null || v.modifier?.kind === 'arbitrary' ? null : `${f}/${m}`;
  ...
  function Ur(e) {
    ...
    function t(l, p) {
      r.static(l, () =>
        p.map((g) => (typeof g == 'function' ? g() : o(g[0], g[1])))
      );
    }
    function n(l, p) {
          ...
          if (b.value)
            if (b.value.kind === 'arbitrary') {
              ...
              if ($ === null && A && p.handleNegativeBareValue) {
                if (
                  (($ = p.handleNegativeBareValue(b.value)),
                  !$?.includes('/') && b.modifier)
                )
                  return;
        ...
        i(l, () => [
          {
            ...
            hasDefaultValue:
              p.defaultValue !== void 0 && p.defaultValue !== null,
    ...
    (r.static('container', () => {
      ...
      for (let g of l)
        p.push(M('@media', `(width >= ${g})`, [o('max-width', g)]));
      return p;
    }),
      ...
      r.functional('flex', (l) => {
        if (l.value) {
          if (l.value.kind === 'arbitrary')
            return l.modifier ? void 0 : [o('flex', l.value.value)];
          if (l.value.fraction) {
    ...
    for (let l of ['x', 'y', 'z'])
      (n(`scale-${l}`, {
        ...
        handle: (p) => [
          ...
          o(
            'scale',
            `var(--tw-scale-x) var(--tw-scale-y)${l === 'z' ? ' var(--tw-scale-z)' : ''}`
          ),
        ],
      }),
        i(`scale-${l}`, () => [
      ...
      ]));
    {
      ...
      (n('skew', {
        ...
        r.functional('transform', (g) => {
          ...
          if (
            (g.value
              ? g.value.kind === 'arbitrary' && (A = g.value.value)
              : (A = l),
            A !== null)
          )
    ...
    for (let [l, p] of [
      ...
      a(l, ['--scroll-margin', '--spacing'], (g) => [o(p, g)], {
        supportsNegative: !0,
      });
    for (let [l, p] of [
    ...
    (t('grid-flow-row', [['grid-auto-flow', 'row']]),
      ...
      n('grid-cols', {
        ...
        handleBareValue: ({ value: l }) =>
          zt(l) ? `repeat(${l}, minmax(0, 1fr))` : null,
        ...
        r.functional('bg-radial', ($) => {
          ...
          if ($.value.kind === 'arbitrary') {
            ...
            return [
              ...
              o(
                'background-image',
                `radial-gradient(var(--tw-gradient-stops,${_}))`
              ),
            ];
          }
        }),
        ...
        if (l.value.kind === 'arbitrary') {
          ...
          switch (
            ...
            default:
              return (
                (p = X(p, l.modifier, e)),
                p === null ? void 0 : [o('background-color', p)]
              );
          }
        }
        {
        ...
        if (g.value) {
          if (g.value.kind === 'arbitrary') {
            ...
            switch (
              ...
              case 'percentage':
                return g.modifier || !E(A.slice(0, -1))
                  ? void 0
                  : p.position(A);
              default:
                return g.modifier ? void 0 : p.position(A);
          ...
          }
          {
            ...
            switch (A) {
              ...
              case 'percentage':
                return E(g.value.value.slice(0, -1))
                  ? p.position(g.value.value)
                  : void 0;
              default:
                return;
            }
      ...
      r.functional('stroke', (l) => {
        if (l.value) {
          if (l.value.kind === 'arbitrary') {
            ...
            switch (
              l.value.dataType ??
              Z(p, ['color', 'number', 'length', 'percentage'])
            ) {
              case 'number':
              case 'length':
              case 'percentage':
              ...
              default:
                return (
                  (p = X(l.value.value, l.modifier, e)),
                  p === null ? void 0 : [o('stroke', p)]
                );
            }
          }
          {
      ...
      r.functional('font', (l) => {
        if (!(!l.value || l.modifier)) {
          if (l.value.kind === 'arbitrary') {
            ...
            switch (
              l.value.dataType ??
              Z(p, ['number', 'generic-name', 'family-name'])
            ) {
              case 'generic-name':
              case 'family-name':
      ...
      r.functional('decoration', (l) => {
        if (l.value) {
          if (l.value.kind === 'arbitrary') {
            ...
            switch (
              l.value.dataType ??
              Z(p, ['color', 'length', 'percentage'])
            ) {
              case 'length':
              case 'percentage':
                return l.modifier
                  ? void 0
                  : [o('text-decoration-thickness', p)];
              default:
                return (
                  (p = X(p, l.modifier, e)),
                  p === null ? void 0 : [o('text-decoration-color', p)]
                );
            }
          }
          {
      ...
      (r.static('outline-hidden', () => [
        ...
        r.functional('outline', (p) => {
          ...
          if (p.value.kind === 'arbitrary') {
            ...
            switch (
              p.value.dataType ??
              Z(g, ['color', 'length', 'number', 'percentage'])
            ) {
              case 'length':
              case 'number':
              case 'percentage':
              ...
              default:
                return (
                  (g = X(g, p.modifier, e)),
                  g === null ? void 0 : [o('outline-color', g)]
                );
            }
          }
          {
    ...
    (n('opacity', {
      ...
      i('opacity', () => [
        {
          values: Array.from({ length: 21 }, (l, p) => `${p * 5}`),
      ...
      r.functional('text-shadow', (l) => {
        ...
        switch (l.value.value) {
          ...
          case 'inherit':
            return l.modifier
              ? void 0
              : [L(), o('--tw-text-shadow-color', 'inherit')];
        }
        {
        ...
        }
        {
          ...
          if (g)
            return [
              L(),
              o('--tw-text-shadow-color', Q(g, 'var(--tw-text-shadow-alpha)')),
            ];
        }
      }),
      i('text-shadow', () => [
        ...
        r.functional('shadow', (N) => {
              ...
              case 'color':
                return (
                  ...
                  I === null
                    ...
                    : [
                        g(),
                        o('--tw-shadow-color', Q(I, 'var(--tw-shadow-alpha)')),
                      ]
                );
              default:
                return [
          ...
          switch (N.value.value) {
            case 'none':
              return N.modifier
                ? void 0
                : [g(), o('--tw-shadow', p), o('box-shadow', l)];
            case 'inherit':
              return N.modifier
                ? void 0
                : [g(), o('--tw-shadow-color', 'inherit')];
          }
          {
        ...
        r.functional('inset-shadow', (N) => {
            ...
            return I === null
              ...
              : [
                  ...
                  ...he(
                    ...
                    I,
                    S,
                    (ce) => `var(--tw-inset-shadow-color, ${ce})`
                  ),
                  o('box-shadow', l),
                ];
          }
          ...
          switch (N.value.value) {
            case 'none':
              return N.modifier
                ? void 0
                : [g(), o('--tw-inset-shadow', p), o('box-shadow', l)];
            case 'inherit':
              return N.modifier
                ? void 0
                : [g(), o('--tw-inset-shadow-color', 'inherit')];
          }
          {
        ...
        if (N.value.kind === 'arbitrary') {
          ...
          switch (N.value.dataType ?? Z(S, ['color', 'length'])) {
            case 'length':
              return N.modifier
                ? void 0
                : [g(), o('--tw-ring-shadow', b(S)), o('box-shadow', l)];
            default:
              return (
                (S = X(S, N.modifier, e)),
                S === null ? void 0 : [o('--tw-ring-color', S)]
              );
          }
        }
        {
            ...
            switch (N.value.dataType ?? Z(S, ['color', 'length'])) {
              case 'length':
                return N.modifier
                  ...
                  : [
                      g(),
                      o('--tw-inset-ring-shadow', $(S)),
                      o('box-shadow', l),
                    ];
              default:
                return (
                  (S = X(S, N.modifier, e)),
                  S === null ? void 0 : [o('--tw-inset-ring-color', S)]
                );
            }
          }
          {
            ...
            switch (N.value.dataType ?? Z(S, ['color', 'length'])) {
              case 'length':
                return N.modifier
                  ? void 0
                  : [
                      o('--tw-ring-offset-width', S),
                      o('--tw-ring-offset-shadow', _),
                    ];
              default:
                return (
                  (S = X(S, N.modifier, e)),
                  S === null ? void 0 : [o('--tw-ring-offset-color', S)]
                );
            }
          }
          {
      ...
      ? (i) => {
          ...
          (D(e.nodes, (n) => {
            if (
              n.kind !== 'declaration' ||
              !n.value ||
              (!n.value.includes('--value(') &&
                !n.value.includes('--modifier('))
            )
              return;
            let s = G(n.value);
            (D(s, (a) => {
...
`);
  ...
  function he(e, r, i, t, n = '') {
      ...
      a = Fe(r, (c) =>
        i == null
          ...
          : c.startsWith('current')
            ? t(Q(c, i))
            : ((c.startsWith('var(') || i.startsWith('var(')) && (s = !0),
              t(Pr(c, i)))
      );
    function m(c) {
      return n
    ...
    return s
      ? [
          o(e, m(Fe(r, t))),
          Y('@supports (color: lab(from red l a b))', [o(e, m(a))]),
        ]
      : [o(e, m(a))];
  }
  ...
  function Ko(e, r, i, ...t) {
    ...
    let n = !1;
    (i.endsWith(' inline') && ((n = !0), (i = i.slice(0, -7))),
      r.kind === 'at-rule' && (n = !0));
  ...
  function Wr(e) {
    ...
    (r.compound('not', 3, (u, h) => {
      if ((h.variant.kind === 'arbitrary' && h.variant.relative) || h.modifier)
        return null;
      let d = !1;
      if (
        (D([u], (f, v) => {
      ...
      r.compound('group', 2, (u, h) => {
        ...
        if (
          (D([u], (v, k) => {
            ...
            for (let x of k.path())
              if (x.kind === 'rule') return ((f = !1), O.Stop);
    ...
    (i('first', ['&:first-child']),
      ...
      r.compound('in', 2, (u, h) => {
        ...
        if (
          (D([u], (f, v) => {
            ...
            ((f.selector = `:where(${f.selector.replaceAll('&', '*')}) &`),
              (d = !0));
          }),
          !d)
        )
      ...
      r.compound('has', 2, (u, h) => {
        ...
        if (
          (D([u], (f, v) => {
            ...
            for (let k of v.path())
              if (k.kind === 'rule') return ((d = !1), O.Stop);
            ((f.selector = `&:has(${f.selector.replaceAll('&', '*')})`),
              (d = !0));
          }),
          !d)
        )
      ...
      r.functional('nth', (u, h) => {
        if (
          !h.value ||
          h.modifier ||
          (h.value.kind === 'named' && !E(h.value.value))
        )
          return null;
      ...
      i('contrast-less', ['@media (prefers-contrast: less)']));
    {
      ...
      var c = u;
      {
        ...
        (r.group(
          ...
          r.suggest('max', () =>
            Array.from(h.keys()).filter((f) => f !== null)
          ),
          r.group(
            () => {
  ...
  function ve(e, r, { onInvalidCandidate: i, respectImportant: t } = {}) {
    ...
    return (
      s.sort((u, h) => {
        let d = n.get(u),
          f = n.get(h);
        if (d.variants - f.variants !== 0n)
          return Number(d.variants - f.variants);
        let v = 0;
        for (
          ;
    ...
    D([t], (d, f) => {
      if (d.kind === 'at-rule') {
        ...
        if (d.name === '@apply') {
          ...
          ((i |= 1), n.add(f.parent));
          for (let v of Zr(d, r))
            for (let k of f.path()) n.has(k) && s.get(k).add(v);
        }
      }
    });
    let m = new Set(),
...
${oe([v])}`)
        ...
        for (let v of s.get(d))
          for (let k of a.get(v)) (f.push(d), h(k, f), f.pop());
  ...
  function Qr(e, r = [], i) {
    for (let t of Reflect.ownKeys(e)) {
      ...
      if (a !== 1) {
        if (a === 2) return 2;
        if (!(!Array.isArray(n) && typeof n != 'object') && Qr(n, s, i) === 2)
          return 2;
      }
    }
  }
...
`
    ...
    for (let i of z(e, '.')) {
      ...
      for (;;) {
        let n = i.indexOf('[', t),
          s = i.indexOf(']', n);
        if (n === -1 || s === -1) break;
        (n > t && r.push(i.slice(t, n)),
          r.push(i.slice(n + 1, s)),
          (t = s + 1));
      }
    ...
    return function (n, s) {
      ...
      let c = (() => {
        let u = mt(n),
          ...
          f = i(ci(r() ?? {}, u) ?? null);
        if (
          (typeof f == 'string' && (f = f.replace('<alpha-value>', '1')),
          typeof h != 'object')
        )
        ...
        if (f !== null && typeof f == 'object' && !Array.isArray(f)) {
          ...
          for (let k in h)
            k !== '__CSS_VALUES__' &&
              ((f?.__CSS_VALUES__?.[k] & 4 && ci(v, k.split('-')) !== void 0) ||
                (v[ye(k)] = h[k]));
          return v;
        }
      ...
      matchVariant(m, c, u) {
        ...
        (e.variants.group(
          () => {
            e.variants.functional(m, (f, v) => {
              ...
              if (v.value.kind === 'arbitrary')
                f.nodes = h(v.value.value, v.modifier, f.nodes);
          ...
          e.variants.suggest(m, () =>
            Object.keys(u?.values ?? {}).filter((f) => f !== 'DEFAULT')
          ));
      },
      addUtilities(m) {
    ...
    for (let [t, n] of i)
      if (n != null && n !== !1)
        if (typeof n != 'object') {
          ...
          for (let s of n)
            typeof s == 'string' ? r.push(o(t, s)) : r.push(Y(t, pe(s)));
  ...
  function Ht(e, r) {
    ...
    for (let n of i.configs)
      ('darkMode' in n &&
        n.darkMode !== void 0 &&
        (i.result.darkMode = n.darkMode ?? null),
        'prefix' in n &&
          n.prefix !== void 0 &&
          (i.result.prefix = n.prefix ?? ''),
        'blocklist' in n &&
          n.blocklist !== void 0 &&
          (i.result.blocklist = n.blocklist ?? []),
        'important' in n &&
          n.important !== void 0 &&
          (i.result.important = n.important ?? !1));
    let t = kn(i);
    return {
      resolvedConfig: {
        ...i.result,
  ...
  function qt(e, { config: r, base: i, path: t, reference: n, src: s }) {
    ...
    for (let u of r.presets ?? [])
      qt(e, { path: t, base: i, config: u, reference: n, src: s });
    for (let u of a)
      (e.plugins.push(u),
        u.config &&
          qt(e, {
    ...
    for (let u of c)
      e.content.files.push(typeof u == 'object' ? u : { base: i, pattern: u });
    e.configs.push(r);
  }
  function kn(e) {
    let r = new Set(),
    ...
    (e.utilities.suggest('bg-left-top', () => []),
      ...
      e.utilities.functional('flex-grow', (r) => {
        if (!r.modifier) {
          ...
          if (r.value.kind === 'arbitrary')
            return [o('flex-grow', r.value.value)];
...
`)) {
  ...
  async function Nn(
    e,
    { base: r = '', from: i, loadModule: t = Cn, loadStylesheet: n = Tn } = {}
  ) {
    let s = 0;
      ...
      if (
        ...
        if (y.nodes.length === 0) {
          ...
          if (U.length === 0 || U.some((B) => B.trim() === ''))
            throw new Error(
              `\`@custom-variant ${P} (${U.join(',')})\` selector is invalid.`
            );
          let j = [],
            W = [];
          for (let B of U)
        ...
        return (
          D(y.nodes, (U) => {
            if (U.kind === 'at-rule' && U.name === '@keyframes')
              return (m.addKeyframes(U), O.Skip);
...
${j}`);
    ...
    for (let y of Ei(u, {
      onCircularDependency(K, R) {
        let P = oe(
          K.map((L, U) =>
            M('@custom-variant', L, [M('@variant', K[U + 1] ?? R, [])])
          )
        )
          .replaceAll(';', ' { \u2026 }')
          .replace(
...
${P}`);
  ...
  async function Sn(e, r = {}) {
    ...
    t.unshift(
      Xe(`! tailwindcss v${Jt} | MIT License | https://tailwindcss.com `)
    );
    function u(k) {
